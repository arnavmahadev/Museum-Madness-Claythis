...
namespace XtremeFPS.Editor
{
    ...
    public class WeaponSystemEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            uni_WeaponSystem.cameraTransform = (Transform)EditorGUILayout.ObjectField(
            new GUIContent("Camera Transform", "The camera from which the raycast will be cast (usually Main Camera)."),
            uni_WeaponSystem.cameraTransform,
            typeof(Transform),
            true
            );
